...
if __name__ == '__main__':
    ...
    filename = r'\optimization_history_2x22-greedy-only.xlsx'
    # ------------------
    ga_start_time = time.time()
    ga = GA(pop_size=1000, max_gen=5000, mut_prob=0.2,
    ...
    standardized = standardize_solution(best_solution, instance_data, "ga_greedy_only", instance_name)
